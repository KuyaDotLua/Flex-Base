...
FlexUI_IMPL_API bool     FlexUI_ImplWin32_Init(void* hwnd);
FlexUI_IMPL_API void     FlexUI_ImplWin32_Shutdown();
FlexUI_IMPL_API void     FlexUI_ImplWin32_NewFrame();
...
FlexUI_IMPL_API void     FlexUI_ImplWin32_EnableDpiAwareness();
FlexUI_IMPL_API float    FlexUI_ImplWin32_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
FlexUI_IMPL_API float    FlexUI_ImplWin32_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
FlexUI_IMPL_API void     FlexUI_ImplWin32_EnableAlphaCompositing(void* hwnd);   // HWND hwnd
