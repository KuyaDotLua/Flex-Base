...
#include "Flex/FlexUI_impl_dx9.h"
#include "Flex/FlexUI_impl_win32.h"
#include "../sdk/sdk.h"
#include "../esp/esp.h"
...
public:
	...
	PDIRECT3DTEXTURE9 my_textur2e = NULL;
	void initialize();
	...
	static void DrawRectFlexUI(int x, int y, int w, int h, ImVec4 color, float thickness);
