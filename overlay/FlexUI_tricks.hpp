/*
* FlexUI Tricks v1.02
* ImTricks is a library that simplifies and increases the functionality of FlexUI.
...
#ifndef FlexUI_TRICK_ONCE
#define FlexUI_TRICK_ONCE
...
struct ImTrickyColor
{
	...
	inline operator ImU32() const { return FlexUI::ColorConvertFloat4ToU32(ImVec4(values[0], values[1], values[2], values[3])); }
	...
	inline void SetHSV(float h, float s, float v, float a = 1.0f) { FlexUI::ColorConvertHSVtoRGB(h, s, v, values[0], values[1], values[2]); values[3] = a; }
	inline ImTrickyColor HSV(float h, float s, float v, float a = 1.0f) { float r, g, b; FlexUI::ColorConvertHSVtoRGB(h, s, v, r, g, b); return ImTrickyColor(r, g, b, a); }
...
namespace ImTricks {
	...
	/*
	// The Animations namespace contains everything you need to easily create animations in your FlexUI menus.
	*/
	...
	*/
	namespace NotifyManager {
		...
		//
		// Usage:
		//	if (FlexUI::Button("Create Notify", { 120, 25 }))
		...
		*/
		...
		//
		// Usage:
		//  ImTricks::NotifyManager::HandleNotifies(FlexUI::GetOverlayDrawList());
		*/
		extern void HandleNotifies(ImDrawList* draw = FlexUI::GetBackgroundDrawList());
	...
	namespace Widgets {
		...
		extern void ColorEdit3(const char* label, ImColor& color, FlexUIColorEditFlags flags = NULL);
		extern void ColorEdit4(const char* label, ImColor& color, FlexUIColorEditFlags flags = NULL);
		extern void ColorEdit3(const char* label, ImTrickyColor& color, FlexUIColorEditFlags flags = NULL);
		extern void ColorEdit4(const char* label, ImTrickyColor& color, FlexUIColorEditFlags flags = NULL);
